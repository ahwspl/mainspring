# Mainspring Scheduler

[comment]: <> (![Apache]&#40;https://img.shields.io/hexpm/l/plug.svg&#41; )

[comment]: <> ([![Build Status]&#40;https://travis-ci.org/Nextdoor/ndscheduler.svg&#41;]&#40;https://travis-ci.org/Nextdoor/ndscheduler&#41;)
...
## Table of contents
  ...
  * [How to build Your own cron-replacement](#how-to-build-your-own-cron-replacement)
    * [Install mainspring](#install-ndscheduler)
    * [Three things](#three-things)
    * [Reference Implementation](#reference-implementation)   
  * [Contribute code to mainspring](#contribute-code-to-ndscheduler)
  * [REST APIs](#rest-apis)
  * [Web UI](#web-ui)

## Key Abstractions

* [Core](https://github.com/darshitkothari/mainspring/tree/master/mainspring/core): a bunch of resuable components
  * [Datastore](https://github.com/darshitkothari/mainspring/tree/master/mainspring/core/datastore): manages database connections and makes queries; could support Postgres, MySQL, and sqlite.
  ...
  * [ScheduleManager](https://github.com/darshitkothari/mainspring/blob/master/mainspring/core/scheduler_manager.py): access Datastore to manage jobs, i.e., schedule/modify/delete/pause/resume a job.
* [Server](https://github.com/darshitkothari/mainspring/tree/master/mainspring/server): a tornado server that runs ScheduleManager and provides REST APIs and serves UI.
* [Web UI](https://github.com/darshitkothari/mainspring/tree/master/mainspring/static): a single page HTML app; this is a default implementation.
...
![mainspring demo](https://giant.gfycat.com/NastyBossyBeaver.gif)
