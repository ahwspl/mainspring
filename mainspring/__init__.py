...
ENVIRONMENT_VARIABLE = 'MAINSPRING_SETTINGS_MODULE'
...
def setup_package():
    ...
    os.environ[ENVIRONMENT_VARIABLE] = 'mainspring.default_settings_test'
...
class Settings(object):
    """Singleton class to manage mainspring settings."""
