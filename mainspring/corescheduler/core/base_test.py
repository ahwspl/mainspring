...
from mainspring.corescheduler.core.base import BaseScheduler
...
class BaseSchedulerTest(unittest.TestCase):
    ...
    def test_is_okay_to_run(self):
        with mock.patch(('mainspring.corescheduler.core.base.BaseScheduler.is_okay_to_run')) as mock_should_run:
